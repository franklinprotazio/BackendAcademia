...
public class TurmaNaoVinculadaException extends Exception {
	...
	public TurmaNaoVinculadaException(String menssagem) {
		super(menssagem);
	}
	 ...
	 * @param causa
	 */
	public TurmaNaoVinculadaException(Exception causa) {
		super(causa);
	}
	 ...
	 * @param causa
	 */
	public TurmaNaoVinculadaException(String menssagem, Exception causa) {
